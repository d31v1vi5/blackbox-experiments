...
```sh
git clone git@github.com:d31v1vi5/blackbox-experiments.git
cd blackbox-experiments
```
...
#### Commit your changes
```sh
git commit -m 'Starting blackbox-experiments'
...
```sh
./mill blackbox-experiments.test
```
